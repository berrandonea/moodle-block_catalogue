...
$string['descdisplayedlists'] = 'Possible values : activities, blocks, customlabels (requires mod_customlabel), enrols, grades, mods(activities and resources together), reports, resources. Write them with no blanck space, separated by commas.';
...
$string['reports_description_report_participation'] = "Shows the learners participation in the cours, sorted by activity module, status and group.";
...
$string['sections_goto'] = 'Go to section';
