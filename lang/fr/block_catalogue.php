...
$string['chooseplace'] = 'Choisissez une section';
...
$string['descdisplayedlists'] = 'Valeurs possibles : activities (Activités), blocks (Blocs), customlabels (Eléments de cours, requiert mod_customlabel), enrols (Inscrire des étudiants), grades (Notes), mods (Activités et ressources ensemble), reports (Rapports), resources (Ressources), sections. A écrire sans espaces, séparés par des virgules.';
...
$string['sections_goto'] = 'Aller à la section';
